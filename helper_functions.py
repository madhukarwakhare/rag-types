#pip install langchain openai langchain-openai langchain-community pydantic rank-bm25 PyMuPDF numpy langchain-cohere
...
def retrieve_context_per_question(question, chunks_query_retriever):
    ...
    # Retrieve relevant documents for the given question (use invoke instead of deprecated get_relevant_documents)
